            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="client.php" class="active-submenu">Famille</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-md-12 form-box">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="panel panel-default">
                                <div class="form-top">
                                    <div class="form-top-left">
                                        <h3><span><i class="fa fa-calendar-check-o" aria-hidden="true"></i></span>Client Famille</h3>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade active in" id="home-pills">
                                            ...
                                            <div class="col-md-12 form-box">
                                                <br>
                                                <form role="form" class="registration-form" action="" method="post" name="add_cltForm">
                            <fieldset>
                            ...
                            echo'<form class="registration-form" method="get" name="putMod_cltForm">
                            <fieldset>
                                <div class="form-bottom">
                                    <div class="row">
                                        <div class="form-group col-md-3 col-sm-6">
                            ...
                            if(isset($_GET['cin'])){
                                ...
                                echo '<form role="form" class="registration-form" action="" name="modifier_cltForm" method="post">
                            <fieldset>
                                <div class="form-bottom">
                                    <div class="row">
                                       <div class="form-group col-md-3 col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3 col-sm-6">
                                            <label>Numéro de Téléphone :</label>
                                            <input type="tel" class="form-control" id="ref" value="'.$row[4].'" minlength="10" maxlength="14" pattern="^(?:0|\(?\+212\)?\s?|00212\s?)[1-79](?:[\.\-\s]?\d\d){4}$"  name="modNum" required/>
                                        </div>
                                    </div>
                                    <div class="nxt-prv">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span style="font-weight: bold">Liste des clients Famille</span>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                           <?php
                                            $query = "SELECT * from clients where CIN_clt=CIN_clt_famille;";
                                            $result = mysqli_query($conn,$query);
...
if(isset($_POST['ajouter'])){
    ...
    $addnum = $_POST['addNum'];
    $query = "INSERT INTO clients VALUES('$addcin','$addcin','$addnom','$addprenom','$addnum');";
...
if(isset($_POST['modiferForm'])){
    ...
    $modnum = $_POST['modNum'];
    $query = "UPDATE clients SET CIN_clt='$modcin',CIN_clt_famille='$modcin',Nom_clt='$modnom',Prenom_clt='$modprenom',Num_tele_clt='$modnum' WHERE CIN_clt='$oldcin';";
    if(mysqli_query($conn,$query)){
