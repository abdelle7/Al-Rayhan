        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="fourniseur.php" class="active-menu"><i class="fa fa-truck fa-3x"></i> Fournisseur</a>
                    </li>
                    <li>
                            ...
                            <div class="panel panel-default">
                                <div class="form-top">
                                    <div class="form-top-left">
                                        <h3><span><i class="fa fa-calendar-check-o" aria-hidden="true"></i></span>Fournisseur</h3>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade active in" id="home-pills">
                                            ...
                                            <div class="col-md-12 form-box">
                                                <br>
                                                <form role="form" class="registration-form" action="" method="post" name="add_FourForm">
                            <fieldset>
                                <div class="form-bottom">
                                    <div class="row">
                                       <div class="form-group col-md-3 col-sm-6">
                                            <label>N&deg; :</label>
                                            <input type="text" class="form-control" id="ref" value="" name="addNfour" required />
                                        </div>
                                        <div class="form-group col-md-3 col-sm-6">
                                            <label>Nom :</label>
                                    ...
                                    <div class="nxt-prv">
                                        ...
                                        <div class="tab-pane fade" id="profile-pills">
                                            ...
                                            <?php
                                                ...
                                                if(!isset($_GET['Nfour'])){
                            echo'<form class="registration-form" method="get" name="putMod_fourForm">
                            <fieldset>
                                <div class="form-bottom">
                                    <div class="row">
                                        <div class="form-group col-md-3 col-sm-6">
                                            <label>N&deg; :</label>
                                            <input type="text" class="form-control" id="ref" value="" name="Nfour" required />
                                        </div>
                                    </div>
                                    <div class="nxt-prv">
                                        <button type="submit" class="btn btn-next">Modifier</button>
                                                ...
                                                if(isset($_GET['Nfour'])){
                                                $Nfour=$_GET['Nfour'];
                                $query="select * from fournisseur where Numero_four='".$Nfour."'";
                                $result=mysqli_query($conn,$query);
                                $row=mysqli_fetch_row($result);
                                                    echo '<form role="form" class="registration-form" action="" name="modifier_fourForm" method="post">
                            <fieldset>
                                <div class="form-bottom">
                                    <div class="row">
                                       <div class="form-group col-md-3 col-sm-6">
                                            <label>N&deg; :</label>
                                            <input type="text" class="form-control" id="ref" value="'.$row[0].'" name="modNfour"  required />
                                        </div>
                                        <div class="form-group col-md-3 col-sm-6">
                                            <label>Nom :</label>
                            ...
                            <fieldset>
                                <div class="form-bottom">
                                    <div class="row">
                                        <div class="form-group col-md-3 col-sm-6">
                                            <label>N&deg; :</label>
                                            <input type="text" class="form-control" id="ref" value="" name="delNfour" required/>
                                        </div>
                                    </div>
                                    <div class="nxt-prv">
                                           ...
                                           <?php
                                            ...
                                            if(mysqli_num_rows($result)>0){
                                                while($row=mysqli_fetch_assoc($result)){
                                                    echo"<tr>
                                                <td><a href='?Nfour=".$row['Numero_four']."'>".$row['Numero_four']."</a></td>
                                                <td>".$row['Nom_four']."</td>
                                                <td>".$row['Adresse_four']."</td>
                                                <td class='center'>".$row['Numero_tele_four']."</td>
                                            </tr>";
                                                }
                                            }
                                             ?>
...
<div class="modal fade" id="modifierModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" >
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <script>
        ...
        function reload(){
            window.location.replace("fourniseur.php");
        }
        function modalPopup(){
...
if(isset($_POST['ajouter'])){
    $addNfour = $_POST['addNfour'];
    $addnom = $_POST['addNom'];
    $addadresse = $_POST['addAdresse'];
    $addnum = $_POST['addNum'];
    $query = "INSERT INTO fournisseur VALUES('$addNfour','$addnom','$addadresse','$addnum');";
...
if(isset($_POST['modiferForm'])){
    $modNfour = $_POST['modNfour'];
    $oldNfour=$_GET['Nfour'];
    $modnom = $_POST['modNom'];
    $modadresse = $_POST['modAdresse'];
    $modnum = $_POST['modNum'];
    $query = "UPDATE fournisseur SET Numero_four='$modNfour',Nom_four='$modnom',Adresse_four='$modadresse',Numero_tele_four='$modnum' WHERE Numero_four='$oldNfour';";
    if(mysqli_query($conn,$query)){
...
if(isset($_POST['deleteForm'])){
    $delNfour = $_POST['delNfour'];
    $query = "DELETE FROM fournisseur WHERE Numero_four='$delNfour';";
    if(mysqli_query($conn,$query)){
